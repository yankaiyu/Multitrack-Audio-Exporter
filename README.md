...
To stop the app, close its Terminal window. If the window was closed but the service remains running, execute this in Terminal:
...
关闭其 Terminal 窗口即可停止服务。若窗口已关闭但服务仍在运行，可在 Terminal 执行：
